...
function merge(
  ...
  while (i <= middleIdx && j <= endIdx) {
    // These are the values we're comparing; we push them once to change their color.
    animations.push([i, j]);
    // These are the values we're comparing; we push them a second time to revert their color.
    animations.push([i, j]);
